<!--
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
                ...
                <div class="mt-2">
                <input id="exail" type="email" name="email" required autocomplete="email" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                </div>
            </div>
            ...
            belum punya akun?
            <a href="{{route('auth.register')}}" class="font-semibold text-indigo-400 hover:text-indigo-300">register</a>
            </p>
        </div>
        </div>