    ...
    <div class="mb-8">
        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            <h1 class="text-3xl font-bold text-white tracking-tight">
                Create <span class="text-[#4ade80]">Author</span>
            </h1>
    ...
    <div class="max-w-xl">
        ...
        <div class="rounded-2xl border border-white/[0.06] bg-[#1a1d27] shadow-2xl overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-white/[0.06] flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-[#c4c9d9]">New Author</span>
            </div>

            {{-- Form --}}
            <form action="{{ route('penulis.store') }}" method="POST" class="px-6 py-7 space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full pl-10 pr-4 py-3 rounded-xl bg-[#111318] border border-white/[0.08] text-sm text-white placeholder-[#7c8497] focus:outline-none focus:border-[#4ade80]/60 focus:ring-1 focus:ring-[#4ade80]/20 transition-all duration-150 @error('name_author') border-[#f87171]/50 @enderror"
                        />
                    </div>
                    @error('name_author')
                ...
                <div>
                    <label for="age" class="block text-xs font-semibold tracking-widest text-[#7c8497] uppercase mb-2">
                        Umur <span class="text-[#f87171]">*</span>
                    </label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg class="w-4 h-4 text-[#7c8497]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <input
                            ...
                            max="120"
                            placeholder="e.g. 35"
                            class="w-full pl-10 pr-4 py-3 rounded-xl bg-[#111318] border border-white/[0.08] text-sm text-white placeholder-[#7c8497] focus:outline-none focus:border-[#4ade80]/60 focus:ring-1 focus:ring-[#4ade80]/20 transition-all duration-150 @error('age') border-[#f87171]/50 @enderror"
                        />
                    </div>
                    @error('age')
                    <p class="mt-2 text-xs text-[#f87171] flex items-center gap-1.5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <textarea
                            ...
                            class="w-full pl-10 pr-4 py-3 rounded-xl bg-[#111318] border border-white/[0.08] text-sm text-white placeholder-[#7c8497] focus:outline-none focus:border-[#4ade80]/60 focus:ring-1 focus:ring-[#4ade80]/20 transition-all duration-150 resize-none @error('alamat') border-[#f87171]/50 @enderror"
                        >{{ old('alamat') }}</textarea>
                    </div>
                    @error('alamat')
                    <p class="mt-2 text-xs text-[#f87171] flex items-center gap-1.5">
        ...
        <div class="mt-4 rounded-xl border border-[#4ade80]/15 bg-[#4ade80]/[0.05] px-5 py-4 flex items-start gap-3">
            ...
            <p class="text-xs text-[#7c8497] leading-relaxed">
                Author data will be used to categorise and display books across the library.
                Make sure the name is correct — it will appear on all associated book entries.
            </p>
        </div>
